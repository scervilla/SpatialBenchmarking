...
object <- readRDS(paste0(file_path,  sample, "_xenium_in_hd_exp.rds"))
coord <- read.table(paste0(file_path, sample, "_xenium_in_hd_coord.rds"))
...
write.table(as.data.frame(rowData(sfe)), paste0(output_path, "morani/", sample,"_morani_xenium_in_hd.txt"))
