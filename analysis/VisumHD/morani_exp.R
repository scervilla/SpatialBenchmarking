...
object <- readRDS(paste0(file_path,  sample, "_HD_sct_exp.rds"))
coord <- read.table(paste0(file_path, sample, "_HD_sct_coord.rds"))
...
write.table(as.data.frame(rowData(sfe)), paste0(output_path, "morani/", sample,"_morani_VisiumHD.txt"))
